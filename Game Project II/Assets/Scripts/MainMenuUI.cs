...
public class MainMenuUI : MonoBehaviour
{
    ...
    public GameObject mapSettingsPanel; // Новая панель Map Settings
    ...
    {
        HideAllPanels();
        if (mapSettingsPanel != null) mapSettingsPanel.SetActive(true);
    }

    public void BackToSettingsFromMap()
    {
        HideAllPanels();
        if (settingsPanel != null) settingsPanel.SetActive(true);
    }
    ...
    private void ShowMainMenu()
    {
        ...
        if (pausePanel != null) pausePanel.SetActive(false);
        if (notesMenuPanel != null) notesMenuPanel.SetActive(false);
        if (mapSettingsPanel != null) mapSettingsPanel.SetActive(false);
    }
